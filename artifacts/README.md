...
To run Cypher queries, you need to install the yProv service and Neo4j database locally (Step 8). Once the service is running locally, you will be able to perform the Cypher queries locally reported below.
